...
using MultilanguageMVC4.Resources;

namespace MultilanguageMVC4.Models
{
    ...
    public class RegisterModel
    {
        ...
        [Compare("Password", ErrorMessageResourceType = typeof(Global), ErrorMessageResourceName = "ValidationPasswordsDontMatch")]
        public string ConfirmPassword { get; set; }
    }
